            ...
            <ul class="nav navbar-nav" id="mytab">
                <li class="dropdown active">
                    ...
                    <ul class="dropdown-menu">
                        <li class="call-teacher-info"><a href="javascript:void(0);">教师信息</a></li>
                        <li role="presentation" class="divider"></li>
                        <li class="call-courseclass-info"><a href="javascript:void(0);">开课班信息</a></li>
                    </ul>
                </li>
                <li class="dropdown">
...
<div class="container-fluid">
    <div class="row">
        ...
        <div class="col-sm-10 col-md-10 col-sm-offset-2 col-md-offset-2 content">
            <div id="teacher-info" class="panel" style="display: block">
                <div class="embed-responsive" style="height: 620px">
                    <iframe class="embed-responsive-item" src="panel/showteacherinfo.php"></iframe>
                </div>
            </div>
            <div id="courseclass-info" class="panel" style="display: none">
            <div class="embed-responsive" style="height: 620px">
                <iframe class="embed-responsive-item" src="panel/showcourseclassinfo.php"></iframe>
            </div>
        </div>
        </div>
    </div>
